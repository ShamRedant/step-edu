...
\restrict Ah5YIdjZN2eksgN16KEhbMQbcle0OyQIYhaedIH3TN4TlOTNblq3vrUc4Pkkx6B
...
COPY public.lessons (id, module_id, title, description, content, order_index, created_at, updated_at, created_by, status) FROM stdin;
1	1	rrr	ggg	gggg	1	2025-12-31 08:52:47.426169	2025-12-31 08:52:47.426169	1	active
2	2	Lesson1	Lesson1	Lesson1	1	2025-12-31 10:37:10.193992	2025-12-31 10:37:10.193992	1	active
\.
...
COPY public.modules (id, course_id, title, description, order_index, created_at, updated_at, created_by, status) FROM stdin;
1	1	Poo	hhh	1	2025-12-31 08:52:21.257448	2025-12-31 08:52:21.257448	1	active
2	2	Module 1	Module 1	1	2025-12-31 10:36:36.893901	2025-12-31 10:36:36.893901	1	active
3	2	Module 2	Module 2	2	2025-12-31 10:36:53.123605	2025-12-31 10:36:53.123605	1	active
\.
...
SELECT pg_catalog.setval('public.homework_files_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.student_files_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.teacher_files_id_seq', 2, true);
...
\unrestrict Ah5YIdjZN2eksgN16KEhbMQbcle0OyQIYhaedIH3TN4TlOTNblq3vrUc4Pkkx6B
